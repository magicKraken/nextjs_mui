...
- [Online Demo](https://https://nextjs-mui-eight.vercel.app/)

_Warning: if your are planning to use **Pages Router** (not **App Router**) then use [this template](https://github.com/magicKraken/nextjs-mui)_
